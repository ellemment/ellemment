...
import { Input } from "#app/interface/shadcn/input"
import { Separator } from "#app/interface/shadcn/separator"
import { Sheet, SheetContent } from "#app/interface/shadcn/sheet"
import { Skeleton } from "#app/interface/shadcn/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "mx-auto max-w-6xl group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
