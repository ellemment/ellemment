// #app/interface/components/navigation/menus/menu-popover.tsx
...
export function PopoverButton({ children, onClick, className }: PopoverButtonProps) {
  ...
  return (
    <button
      className={cn(
        "flex w-full items-center gap-2 rounded-md px-4 py-2 text-left text-md font-medium md:text-sm md:font-normal hover:text-gray-600 dark:hover:text-gray-400",
        className
      )}
      onClick={handleClick}
    >
