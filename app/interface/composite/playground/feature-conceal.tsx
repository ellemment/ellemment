// #app/interface/composite/playground/feature-conceal.tsx

import { useScroll, useTransform, motion, type MotionValue } from "framer-motion";
import React, { useRef } from "react";

export const FeatureConceal = () => {
  return (
    <>
...
const CarouselItem = ({ scrollYProgress, position, numItems }: CarouselItemProps) => {
