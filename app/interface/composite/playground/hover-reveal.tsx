// #app/interface/composite/playground/hover-reveal.tsx

import { useMotionValue, motion, useSpring, useTransform } from "framer-motion";
import React, { useRef } from "react";
import { FiArrowRight } from "react-icons/fi";

// Add interface for Link props
interface LinkProps {
  heading: string;
  imgSrc: string;
  subheading: string;
...
export const HoverReveal = () => {
  return (
    <section className="bg-neutral-950 p-4 md:p-8">
      <div className="mx-auto max-w-7xl md:p-4">
        <Link
          heading="About"
...
// Update Link component signature
